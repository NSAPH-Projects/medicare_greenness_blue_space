...
#read data 2df
ndvi_2df_curve_alz <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/ndvi_2df_ind_curve_alzm4.xlsx")
blue_2df_curve_alz <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/blue_2df_ind_curve_alzm4.xlsx")
park_2df_curve_alz <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/park_2df_ind_curve_alzm4.xlsx")

ndvi_2df_curve_par <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/ndvi_2df_ind_curve_parm4.xlsx")
blue_2df_curve_par <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/blue_2df_ind_curve_parm4.xlsx")
park_2df_curve_par <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/park_2df_ind_curve_parm4.xlsx")

#read data 2df urban
ndvi_2df_curve_alz_urb <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/ndvi_2df_ind_curve_alz_urb_m4.xlsx")
blue_2df_curve_alz_urb <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/blue_2df_ind_curve_alz_urb_m4.xlsx")
park_2df_curve_alz_urb <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/park_2df_ind_curve_alz_urb_m4.xlsx")

ndvi_2df_curve_par_urb <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/ndvi_2df_ind_curve_par_urb_m4.xlsx")
blue_2df_curve_par_urb <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/blue_2df_ind_curve_par_urb_m4.xlsx")
park_2df_curve_par_urb <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/park_2df_ind_curve_par_urb_m4.xlsx")

#read data 3df
ndvi_3df_curve_alz <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/ndvi_3df_ind_curve_alzm4.xlsx")
blue_3df_curve_alz <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/blue_3df_ind_curve_alzm4.xlsx")
park_3df_curve_alz <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/park_3df_ind_curve_alzm4.xlsx")

ndvi_3df_curve_par <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/ndvi_3df_ind_curve_parm4.xlsx")
blue_3df_curve_par <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/blue_3df_ind_curve_parm4.xlsx")
park_3df_curve_par <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/park_3df_ind_curve_parm4.xlsx")

#read data 3df urban
ndvi_3df_curve_alz_urb <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/ndvi_3df_ind_curve_alz_urb_m4.xlsx")
blue_3df_curve_alz_urb <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/blue_3df_ind_curve_alz_urb_m4.xlsx")
park_3df_curve_alz_urb <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/park_3df_ind_curve_alz_urb_m4.xlsx")

ndvi_3df_curve_par_urb <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/ndvi_3df_ind_curve_par_urb_m4.xlsx")
blue_3df_curve_par_urb <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/blue_3df_ind_curve_par_urb_m4.xlsx")
park_3df_curve_par_urb <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/park_3df_ind_curve_par_urb_m4.xlsx")

#create pdf
pdf(file="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/figures/nature_ind_splines23_alz_par_m4.pdf", width=8.3, height = 11.7, useDingbats = F)
