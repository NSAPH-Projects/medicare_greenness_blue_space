...
old_merged <- "/nfs/home/J/jok8845/shared_space/ci3_health_data/medicare/gen_admission/1999_2016/Klompmaker/cache_data/hosp_adm/alz_death_correct/"
...
ALZcount<-aggregate(ALZ$death, by=list(ALZ$sex,ALZ$race3,ALZ$entry_age_break.y,ALZ$dual,ALZ$followup_year,ALZ$zip,ALZ$year), FUN=sum)
print("calculated total ALZ death")

write_fst(ALZcount, paste0(new_merged, "ALZ_death_count.fst"))
...
write_fst(aggregate_ALZ, paste0(new_merged, "aggregate_death_ALZ.fst"))
