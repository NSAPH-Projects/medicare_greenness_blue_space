...
exposures_alz <- read_fst(paste0(new_merged ,"aggregate_ALZ.fst"),
                          columns = c("ndvi_summer","occur_bs_1000m","park","popdensity","region4"), as.data.table = T)
...
#read data 1df 
ndvi_1df_curve_alz <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/ndvi_1df_curve_alz_m4.xlsx")
blue_1df_curve_alz <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/blue_1df_curve_alz_m4.xlsx")
park_1df_curve_alz <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/park_1df_curve_alz_m4.xlsx")

ndvi_1df_curve_par <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/ndvi_1df_curve_par_m4.xlsx")
blue_1df_curve_par <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/blue_1df_curve_par_m4.xlsx")
park_1df_curve_par <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/park_1df_curve_par_m4.xlsx")

#read data 1df urban
ndvi_1df_curve_alz_urb <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/ndvi_1df_curve_alz_urb_m4.xlsx")
blue_1df_curve_alz_urb <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/blue_1df_curve_alz_urb_m4.xlsx")
park_1df_curve_alz_urb <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/park_1df_curve_alz_urb_m4.xlsx")

ndvi_1df_curve_par_urb <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/ndvi_1df_curve_par_urb_m4.xlsx")
blue_1df_curve_par_urb <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/blue_1df_curve_par_urb_m4.xlsx")
park_1df_curve_par_urb <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/park_1df_curve_par_urb_m4.xlsx")

#read data 2df
ndvi_2df_curve_alz <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/ndvi_2df_sim_curve_alzm4.xlsx")
blue_2df_curve_alz <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/blue_2df_sim_curve_alzm4.xlsx")
park_2df_curve_alz <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/park_2df_sim_curve_alzm4.xlsx")

ndvi_2df_curve_par <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/ndvi_2df_sim_curve_parm4.xlsx")
blue_2df_curve_par <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/blue_2df_sim_curve_parm4.xlsx")
park_2df_curve_par <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/park_2df_sim_curve_parm4.xlsx")

#read data 2df urban
ndvi_2df_curve_alz_urb <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/ndvi_2df_sim_curve_alz_urb_m4.xlsx")
blue_2df_curve_alz_urb <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/blue_2df_sim_curve_alz_urb_m4.xlsx")
park_2df_curve_alz_urb <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/park_2df_sim_curve_alz_urb_m4.xlsx")

ndvi_2df_curve_par_urb <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/ndvi_2df_sim_curve_par_urb_m4.xlsx")
blue_2df_curve_par_urb <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/blue_2df_sim_curve_par_urb_m4.xlsx")
park_2df_curve_par_urb <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/park_2df_sim_curve_par_urb_m4.xlsx")

#read data 3df
ndvi_3df_curve_alz <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/ndvi_3df_sim_curve_alzm4.xlsx")
blue_3df_curve_alz <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/blue_3df_sim_curve_alzm4.xlsx")
park_3df_curve_alz <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/park_3df_sim_curve_alzm4.xlsx")

ndvi_3df_curve_par <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/ndvi_3df_sim_curve_parm4.xlsx")
blue_3df_curve_par <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/blue_3df_sim_curve_parm4.xlsx")
park_3df_curve_par <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/park_3df_sim_curve_parm4.xlsx")

#read data 3df urban
ndvi_3df_curve_alz_urb <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/ndvi_3df_sim_curve_alz_urb_m4.xlsx")
blue_3df_curve_alz_urb <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/blue_3df_sim_curve_alz_urb_m4.xlsx")
park_3df_curve_alz_urb <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/park_3df_sim_curve_alz_urb_m4.xlsx")

ndvi_3df_curve_par_urb <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/ndvi_3df_sim_curve_par_urb_m4.xlsx")
blue_3df_curve_par_urb <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/blue_3df_sim_curve_par_urb_m4.xlsx")
park_3df_curve_par_urb <- read.csv("~/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/park_3df_sim_curve_par_urb_m4.xlsx")

#create pdf
pdf(file="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/figures/nature_splines23_alz_par_m4.pdf", width=8.3, height = 11.7, useDingbats = F)
...
lines(exposures_alz[region4=="West"]$park,col="blue")
...
par(new=T)
#plot(density(exposures_alz$ndvi_summer,na.rm=T),axes=FALSE,main="", xlab="",ylab="",ylim=c(0,4),col="blue")
#plot(density(west$ndvi_summer,na.rm=T),axes=FALSE,main="", xlab="",ylab="",ylim=c(0,4),col="blue")
plot(density(exposures_alz[region4=="West",]$ndvi_summer,na.rm=T),axes=FALSE,main="", xlab="",ylab="",ylim=c(0,10),col="blue")
par(new=T)
plot(density(exposures_alz[region4=="South",]$ndvi_summer,na.rm=T),axes=FALSE,main="", xlab="",ylab="",ylim=c(0,10),col="red")
par(new=T)
plot(density(exposures_alz[region4=="Midwest",]$ndvi_summer,na.rm=T),axes=FALSE,main="", xlab="",ylab="",ylim=c(0,10),col="green")
par(new=T)
plot(density(exposures_alz[region4=="Northeast",]$ndvi_summer,na.rm=T),axes=FALSE,main="", xlab="",ylab="",ylim=c(0,10),col="orange")
