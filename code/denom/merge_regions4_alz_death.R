...
aggregate_ALZ <- read_fst(paste0(new_merged ,"aggregate_death_ALZ.fst"), as.data.table = T)
...
#merge with dataset
aggregate_ALZ<-merge(aggregate_ALZ,region2,by="zip",all.x=T)

write_fst(aggregate_ALZ, "/nfs/home/J/jok8845/shared_space/ci3_health_data/medicare/gen_admission/1999_2016/Klompmaker/merged_data/alz2/aggregate_death_ALZ.fst")
