...
gc()
nrow(aggregate_RES) #rows=63924393
sum(aggregate_RES$hosp)#9741992
sum(aggregate_RES$time_count)#453244756
...
#save descriptives
write_xlsx(des.exp.all,path="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/descriptives/descr_exposures_strata_res.xlsx")

#calculate spearman correlations
scor.allexp<-cbind(pol=names(aggregate_RES),as.data.frame(cor(aggregate_RES,method="spearman",use="complete.obs")))
write_xlsx(scor.allexp,path="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/descriptives/spm_corr_exposures_strata_res.xlsx")

#calculate pearson correlations
pcor.allexp<-cbind(pol=names(aggregate_RES),as.data.frame(cor(aggregate_RES,method="pearson",use="complete.obs")))
write_xlsx(pcor.allexp,path="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/descriptives/psn_corr_exposures_strata_res.xlsx")
