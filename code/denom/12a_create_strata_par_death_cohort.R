...
old_merged <- "/nfs/home/J/jok8845/shared_space/ci3_health_data/medicare/gen_admission/1999_2016/Klompmaker/cache_data/hosp_adm/par_death_correct/"
...
PARcount<-aggregate(PAR$death, by=list(PAR$sex,PAR$race3,PAR$entry_age_break.y,PAR$dual,PAR$followup_year,PAR$zip,PAR$year), FUN=sum)
print("calculated total PAR death")

write_fst(PARcount, paste0(new_merged, "PAR_death_count.fst"))
...
write_fst(aggregate_PAR, paste0(new_merged, "aggregate_death_PAR.fst"))
