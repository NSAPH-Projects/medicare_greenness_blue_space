...
con<-read_fst("/nfs/home/J/jok8845/shared_space/ci3_analysis/jklompmaker/alz2/cc_zipyear_alz.fst")
covar<-read_fst("/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/data/confounders/merged_covariates.fst")
con<-merge(con, covar, by=c("zip","year"))
setDT(con)
con<-con[popdensity>=1000,]
con<-con[,c("zip","year")]
...
fwrite(cat_out, paste0(resultsdir, "merged_2000_2016_data_sum_alzcc_urb.csv"), row.names = T)
