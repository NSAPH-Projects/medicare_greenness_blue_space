...
aggregate_PAR <- read_fst(paste0(new_merged ,"aggregate_PAR_death.fst"), as.data.table = T)
...
write_fst(aggregate_PAR, "/nfs/home/J/jok8845/shared_space/ci3_health_data/medicare/gen_admission/1999_2016/Klompmaker/merged_data/par2/aggregate_PAR_death.fst")
