...
gc()
aggregate_CVD<-aggregate_CVD[popdensity>=1000,]
nrow(aggregate_CVD) #
sum(aggregate_CVD$hosp)#
sum(aggregate_CVD$time_count)#
...
#save descriptives
write_xlsx(des.exp.all,path="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/descriptives/descr_exposures_strata_urb_cvd.xlsx")

#calculate spearman correlations
scor.allexp<-cbind(pol=names(aggregate_CVD),as.data.frame(cor(aggregate_CVD,method="spearman",use="complete.obs")))
write_xlsx(scor.allexp,path="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/descriptives/spm_corr_exposures_strata_urb_cvd.xlsx")

#calculate pearson correlations
pcor.allexp<-cbind(pol=names(aggregate_CVD),as.data.frame(cor(aggregate_CVD,method="pearson",use="complete.obs")))
write_xlsx(pcor.allexp,path="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/descriptives/psn_corr_exposures_strata_urb_cvd.xlsx")
