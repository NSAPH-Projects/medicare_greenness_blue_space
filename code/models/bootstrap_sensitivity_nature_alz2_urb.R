...
dataplot <- read_fst(paste0(new_merged ,"aggregate_ALZ.fst"),
                     columns = c("sex","race","age_entry","dual","followupyear",
                                 ...
                                 "education","summer_tmmx","summer_sph","summer_pr",
                                 "smoke_rate","region4",
...
write.csv(se_vi_bs,"/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/SE/se_temp_humid_precip_alz_urb.xlsx")
