...
nrow(aggregate_PAR) #
sum(aggregate_PAR$hosp)#
sum(aggregate_PAR$time_count)#
...
#save descriptives
write_xlsx(des.exp.all,path="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/descriptives/descr_exposures_strata_urb_par.xlsx")

#calculate spearman correlations
scor.allexp<-cbind(pol=names(aggregate_PAR),as.data.frame(cor(aggregate_PAR,method="spearman",use="complete.obs")))
write_xlsx(scor.allexp,path="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/descriptives/spm_corr_exposures_strata_urb_par.xlsx")

#calculate pearson correlations
pcor.allexp<-cbind(pol=names(aggregate_PAR),as.data.frame(cor(aggregate_PAR,method="pearson",use="complete.obs")))
write_xlsx(pcor.allexp,path="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/descriptives/psn_corr_exposures_strata_urb_par.xlsx")
