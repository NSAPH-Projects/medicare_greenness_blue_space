...
write.csv(serr,file="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/sensitivity/m5_ndvi_only_cvd_urb.xlsx")
rm(model)
gc()
...
write.csv(serr,file="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/m5_blue_only_cvd_urb.xlsx")
rm(model)
gc()
...
write.csv(serr,file="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/m5_park_only_cvd_urb.xlsx")
rm(model)
gc()
...
write.csv(serr,file="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/m5_blue_no_buffer_cvd_urb.xlsx")
rm(model)
gc()
...
write.csv(serr,file="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/m5_pm25_cvd_urb.xlsx")
rm(model)
gc()
...
serr$out<-c("cvd")
serr$exposure<-c("park","ndvi_summer","occur_bs_1000m")
write.csv(serr,file="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/m5_no2_cvd_urb.xlsx")
rm(model)
gc()
