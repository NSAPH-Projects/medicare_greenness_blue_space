...
comcss<-aggregate_PAR[,c("zip","year")]
comcss<-unique(comcss)
nrow(comcss)
write_fst(comcss, paste0(new_merged, "cc_zipyear_par.fst"))
...
#save descriptives
write_xlsx(des.exp.all,path="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/descriptives/descr_exposures_strata_par_cc.xlsx")

#calculate spearman correlations
scor.allexp<-cbind(pol=names(aggregate_PAR),as.data.frame(cor(aggregate_PAR,method="spearman",use="complete.obs")))
write_xlsx(scor.allexp,path="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/descriptives/spm_corr_exposures_strata_par_cc.xlsx")
