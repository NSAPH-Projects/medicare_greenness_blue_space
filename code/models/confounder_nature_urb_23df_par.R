...
write.csv(stats,file="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/ndvi_blue_2df_sim_stats_par_urb.xlsx")
print("predict model")
...
write.csv(curve.blue,file="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/blue_2df_sim_curve_par_urb.xlsx")
...
stats<-cbind(AIC(model),BIC(model))
colnames(stats)<-c("AIC","BIC")
write.csv(stats,file="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/ndvi_blue_3df_sim_stats_par_urb.xlsx")
print("predict model")
pred <- predict(model, type='terms', terms=c(2:4))
rm(model)
print("bind data")
...
colnames(curve.blue)<-c("exp","pred")
curve.blue<-curve.blue[order(curve.blue$exp),]
write.csv(curve.blue,file="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/blue_3df_sim_curve_par_urb.xlsx")
rm(stats,curve.blue,pred)
gc()