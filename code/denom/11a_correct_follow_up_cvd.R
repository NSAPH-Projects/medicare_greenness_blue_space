nthreads <- 1
cachedir <- "/nfs/home/J/jok8845/shared_space/ci3_health_data/medicare/gen_admission/1999_2016/Klompmaker/cache_data/hosp_adm/cvd/"
new_merged <- "/nfs/home/J/jok8845/shared_space/ci3_health_data/medicare/gen_admission/1999_2016/Klompmaker/cache_data/hosp_adm/cvd/correct_followup/"
...
for (filename in list.files(cachedir)) {
  ...
  year_data <-left_join(year_data,total_years, by = c("qid","year.medicare"))
