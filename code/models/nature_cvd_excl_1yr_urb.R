...
dataplot <- read_fst(paste0(new_merged ,"aggregate__excl_1yrhosp_CVD.fst"),
...
colnames(serr)<-"Beta"
serr$model<-c("excl 1yr")
serr$out<-c("cvd")
serr$exposure<-c("park","ndvi_summer","occur_bs_1000m")
write.csv(serr,file="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/excl_1yr_cvd_urb.xlsx")
...
se_vi_bs$model<-c("excl 1yr")
se_vi_bs$out<-c("cvd")
se_vi_bs$exposure<-c("park","ndvi_summer","occur_bs_1000m")

write.csv(se_vi_bs,"/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/SE/se_excl_1yr_cvd_urb.xlsx")