...
#write.csv(serr,file="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/sensitivity/m4_ndvi_only_alz.xlsx")
#rm(model)
#gc()
...
#serr$out<-c("alz")
#serr$exposure<-rownames(serr)
#write.csv(serr,file="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/m4_blue_only_alz.xlsx")
#rm(model)
#gc()
...
#serr$out<-c("alz")
#serr$exposure<-rownames(serr)
#write.csv(serr,file="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/m4_park_only_alz.xlsx")
#rm(model)
#gc()
...
serr$out<-c("alz")
serr$exposure<-rownames(serr)
write.csv(serr,file="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/m4_blue_no_buffer_alz.xlsx")
rm(model)
gc()
...
serr$out<-c("alz")
serr$exposure<-rownames(serr)
write.csv(serr,file="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/m4_pm25_no2_alz.xlsx")
rm(model)
gc()
...
serr$out<-c("alz")
serr$exposure<-rownames(serr)
write.csv(serr,file="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/m4_temp_humid_precip_alz.xlsx")
...
serr$out<-c("alz")
serr$exposure<-rownames(serr)
write.csv(serr,file="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/m4_no_region_alz.xlsx")
...
serr$out<-c("alz")
serr$exposure<-rownames(serr)
write.csv(serr,file="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/m4_division_alz.xlsx")
...
serr$out<-c("alz")
serr$exposure<-rownames(serr)
write.csv(serr,file="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/m4_tertiary_blue_alz.xlsx")
