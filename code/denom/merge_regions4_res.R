...
aggregate_RES <- read_fst(paste0(new_merged ,"aggregate_RES.fst"), as.data.table = T)
...
write_fst(aggregate_RES, "/nfs/home/J/jok8845/shared_space/ci3_health_data/medicare/gen_admission/1999_2016/Klompmaker/merged_data/res2/aggregate_RES.fst")
