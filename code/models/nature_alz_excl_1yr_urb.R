...
dataplot <- read_fst(paste0(new_merged ,"aggregate_excl_1yrhosp_ALZ.fst"),
...
write.csv(serr,file="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/excl_1yr_alz_urb.xlsx")
...
write.csv(se_vi_bs,"/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/SE/se_excl_1yr_alz_urb.xlsx")