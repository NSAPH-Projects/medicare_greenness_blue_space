...
write.csv(serr,file="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/m1_par_urb.xlsx")
rm(model)
gc()
...
serr$out<-c("par")
serr$exposure<-rownames(serr)
write.csv(serr,file="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/m2_par_urb.xlsx")
rm(model)
gc()
...
serr$out<-c("par")
serr$exposure<-rownames(serr)
write.csv(serr,file="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/m3_par_urb.xlsx")
rm(model)
gc()
...
serr$out<-c("par")
serr$exposure<-rownames(serr)
write.csv(serr,file="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/m4_par_urb.xlsx")
...
write.csv(lin.park,file="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/park_1df_curve_par_urb.xlsx")
#linear ndvi
...
write.csv(lin.ndvi,file="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/ndvi_1df_curve_par_urb.xlsx")
rm(lin.ndvi)
...
write.csv(curve.park,file="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/park_2df_sim_curve_par_urb.xlsx")
rm(curve.park)
print("bind data")
...
write.csv(curve.ndvi,file="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/ndvi_2df_sim_curve_par_urb.xlsx")
rm(curve.ndvi,pred)
gc()
...
colnames(curve.park)<-c("exp","pred")
curve.park<-curve.park[order(curve.park$exp),]
write.csv(curve.park,file="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/park_3df_sim_curve_par_urb.xlsx")
rm(curve.park)
print("bind data")
curve.ndvi<-data.frame(cbind(dataplot$ndvi_summer, pred[,2]))
print("get unique values")
...
colnames(curve.ndvi)<-c("exp","pred")
curve.ndvi<-curve.ndvi[order(curve.ndvi$exp),]
write.csv(curve.ndvi,file="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/ndvi_3df_sim_curve_par_urb.xlsx")
rm(curve.ndvi,pred)
gc()