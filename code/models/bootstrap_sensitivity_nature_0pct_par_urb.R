...
se_vi_bs$model<-c("model blue space 0%")
se_vi_bs$out<-c("par")
se_vi_bs$exposure<-c("park","ndvi_summer","as.factor(occur_bs_1000m_ter)1")

write.csv(se_vi_bs,"/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/SE/se_0pct_blue_par_urb.xlsx")
