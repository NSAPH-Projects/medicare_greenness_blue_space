...
write.csv(serr,file="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/m1_res_urb.xlsx")
rm(model)
gc()
...
serr$out<-c("res")
serr$exposure<-c("park","ndvi_summer","occur_bs_1000m")
write.csv(serr,file="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/m2_res_urb.xlsx")
rm(model)
gc()
...
serr$out<-c("res")
serr$exposure<-c("park","ndvi_summer","occur_bs_1000m")
write.csv(serr,file="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/m3_res_urb.xlsx")
rm(model)
gc()
...
serr$AIC<-AIC(model)
serr$BIC<-BIC(model)
write.csv(serr,file="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/m4_res_urb.xlsx")
...
serr$AIC<-AIC(model)
serr$BIC<-BIC(model)
write.csv(serr,file="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/m5_res_urb.xlsx")
...
write.csv(lin.park,file="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/park_1df_curve_res_urb.xlsx")
#linear ndvi
...
write.csv(lin.ndvi,file="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/ndvi_1df_curve_res_urb.xlsx")
rm(lin.ndvi)
#linear blue space
...
write.csv(lin.blue,file="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/blue_1df_curve_res_urb.xlsx")
rm(lin.blue, pred)
gc()
...
write.csv(stats,file="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/ndvi_blue_2df_sim_stats_res_urb.xlsx")
print("predict model")
...
write.csv(curve.park,file="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/park_2df_sim_curve_res_urb.xlsx")
rm(curve.park)
print("bind data")
...
write.csv(curve.ndvi,file="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/ndvi_2df_sim_curve_res_urb.xlsx")
rm(curve.ndvi)
...
write.csv(curve.blue,file="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/blue_2df_sim_curve_res_urb.xlsx")
...
stats<-cbind(AIC(model),BIC(model))
colnames(stats)<-c("AIC","BIC")
write.csv(stats,file="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/ndvi_blue_3df_sim_stats_res_urb.xlsx")
print("predict model")
pred <- predict(model, type='terms', terms=c(2:4))
rm(model)
print("bind data")
...
colnames(curve.park)<-c("exp","pred")
curve.park<-curve.park[order(curve.park$exp),]
write.csv(curve.park,file="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/park_3df_sim_curve_res_urb.xlsx")
rm(curve.park)
print("bind data")
curve.ndvi<-data.frame(cbind(dataplot$ndvi_summer, pred[,2]))
print("get unique values")
...
colnames(curve.ndvi)<-c("exp","pred")
curve.ndvi<-curve.ndvi[order(curve.ndvi$exp),]
write.csv(curve.ndvi,file="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/ndvi_3df_sim_curve_res_urb.xlsx")
rm(curve.ndvi)
curve.blue<-data.frame(cbind(dataplot$occur_bs_1000m, pred[,3]))
print("get unique values")
curve.blue<-curve.blue[!duplicated(curve.blue), ]
colnames(curve.blue)<-c("exp","pred")
curve.blue<-curve.blue[order(curve.blue$exp),]
write.csv(curve.blue,file="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/confounders/blue_3df_sim_curve_res_urb.xlsx")
rm(stats,curve.blue,pred)
gc()