...
#save descriptives
write_xlsx(des.exp.all,path="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/descriptives/descr_exposures_strata_alz_urb_cc.xlsx")

#calculate spearman correlations
scor.allexp<-cbind(pol=names(aggregate_ALZ),as.data.frame(cor(aggregate_ALZ,method="spearman",use="complete.obs")))
write_xlsx(scor.allexp,path="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/Modeloutput/descriptives/spm_corr_exposures_strata_alz_urb_cc.xlsx")
