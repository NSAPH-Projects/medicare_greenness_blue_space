...
#create pdf
pdf(file="/nfs/home/J/jok8845/shared_space/ci3_analysis/nature_medicare/figures/nature_splines23_cvd_res.pdf", width=8.3, height = 11.7, useDingbats = F)
par(mar = c(4.5, 3, 1, 2),oma=c(6,4,5,3), mfrow=c(4,3))

#plot Park-CVD
matplot(park_1df_curve_cvd$X1,park_1df_curve_cvd$X2,type="l",ylim=c(-0.30,0.2),col=c(1,8,8),lty=c(1,2,2),lwd=c(2,2,2),xlab=expression(paste("Public park")),ylab=paste("HR",sep=""),main=paste("CVD",sep=""))
...
#plot NDVI-CVD
matplot(ndvi_1df_curve_cvd$X1,ndvi_1df_curve_cvd$X2,type="l",ylim=c(-0.20,0.3),col=c(1,8,8),lty=c(1,2,2),lwd=c(2,2,2),xlab=expression(paste("NDVI")),ylab=paste("HR",sep=""),main=paste("CVD",sep=""))
...
#plot Blue-CVD
matplot(blue_1df_curve_cvd$X1,blue_1df_curve_cvd$X2,type="l",ylim=c(-0.20,0.3),col=c(1,8,8),lty=c(1,2,2),lwd=c(2,2,2),xlab=expression(paste("Blue space")),ylab=paste("HR",sep=""),main=paste("CVD",sep=""))
...
#plot Park-CVD
matplot(park_1df_curve_cvd_urb$X1,park_1df_curve_cvd_urb$X2,type="l",ylim=c(-0.30,0.2),col=c(1,8,8),lty=c(1,2,2),lwd=c(2,2,2),xlab=expression(paste("Public park")),ylab=paste("HR",sep=""),main=paste("CVD",sep=""))
...
#plot NDVI-CVD
matplot(ndvi_1df_curve_cvd_urb$X1,ndvi_1df_curve_cvd_urb$X2,type="l",ylim=c(-0.20,0.3),col=c(1,8,8),lty=c(1,2,2),lwd=c(2,2,2),xlab=expression(paste("NDVI")),ylab=paste("HR",sep=""),main=paste("CVD",sep=""))
...
#plot Blue-CVD
matplot(blue_1df_curve_cvd_urb$X1,blue_1df_curve_cvd_urb$X2,type="l",ylim=c(-0.20,0.3),col=c(1,8,8),lty=c(1,2,2),lwd=c(2,2,2),xlab=expression(paste("Blue space")),ylab=paste("HR",sep=""),main=paste("CVD",sep=""))
...
#plot Park-res
matplot(park_1df_curve_res$X1,park_1df_curve_res$X2,type="l",ylim=c(-0.30,0.2),col=c(1,8,8),lty=c(1,2,2),lwd=c(2,2,2),xlab=expression(paste("Public park")),ylab=paste("HR",sep=""),main=paste("res",sep=""))
...
#plot NDVI-res
matplot(ndvi_1df_curve_res$X1,ndvi_1df_curve_res$X2,type="l",ylim=c(-0.20,0.3),col=c(1,8,8),lty=c(1,2,2),lwd=c(2,2,2),xlab=expression(paste("NDVI")),ylab=paste("HR",sep=""),main=paste("res",sep=""))
...
#plot Blue-res
matplot(blue_1df_curve_res$X1,blue_1df_curve_res$X2,type="l",ylim=c(-0.20,0.3),col=c(1,8,8),lty=c(1,2,2),lwd=c(2,2,2),xlab=expression(paste("Blue space")),ylab=paste("HR",sep=""),main=paste("res",sep=""))
...
#plot Park-res
matplot(park_1df_curve_cvd_urb$X1,park_1df_curve_cvd_urb$X2,type="l",ylim=c(-0.30,0.2),col=c(1,8,8),lty=c(1,2,2),lwd=c(2,2,2),xlab=expression(paste("Public park")),ylab=paste("HR",sep=""),main=paste("res",sep=""))
lines(park_2df_curve_cvd_urb$exp,park_2df_curve_cvd_urb$pred, lty=2)
lines(park_3df_curve_cvd_urb$exp,park_3df_curve_cvd_urb$pred, lty=3)
#lines(pm25_4df_cvd_urb$exp,pm25_4df_cvd_urb$pred, lty=4)
legend(0,0.2,legend=c("df=1","df=2","df=3"),lty=1:3,cex=0.7,box.lty=0)
...
#plot NDVI-res
matplot(ndvi_1df_curve_cvd_urb$X1,ndvi_1df_curve_cvd_urb$X2,type="l",ylim=c(-0.20,0.3),col=c(1,8,8),lty=c(1,2,2),lwd=c(2,2,2),xlab=expression(paste("NDVI")),ylab=paste("HR",sep=""),main=paste("res",sep=""))
lines(ndvi_2df_curve_cvd_urb$exp,ndvi_2df_curve_cvd_urb$pred, lty=2)
lines(ndvi_3df_curve_cvd_urb$exp,ndvi_3df_curve_cvd_urb$pred, lty=3)
#lines(pm25_4df_cvd_urb$exp,pm25_4df_cvd_urb$pred, lty=4)
legend(0,0.3,legend=c("df=1","df=2","df=3"),lty=1:3,cex=0.7,box.lty=0)
...
#plot Blue-res
matplot(blue_1df_curve_cvd_urb$X1,blue_1df_curve_cvd_urb$X2,type="l",ylim=c(-0.20,0.3),col=c(1,8,8),lty=c(1,2,2),lwd=c(2,2,2),xlab=expression(paste("Blue space")),ylab=paste("HR",sep=""),main=paste("res",sep=""))
lines(blue_2df_curve_cvd_urb$exp,blue_2df_curve_cvd_urb$pred, lty=2)
lines(blue_3df_curve_cvd_urb$exp,blue_3df_curve_cvd_urb$pred, lty=3)
legend(0,0.3,legend=c("df=1","df=2","df=3"),lty=1:3,cex=0.7,box.lty=0)
par(new=T)
